...
const CAFE_CONFIG = {
   ...
   // welcomeMessage: "خوش آمدید!",
    ...
    // ═══════════════════════════════════════════════════════════════
    // بخش مدیریت اشتراک - برای کنترل دسترسی مشتری
    // ═══════════════════════════════════════════════════════════════
    subscription: {
        // برای فعال کردن صفحه "اشتراک تمام شده"، این مقدار را به true تغییر دهید
        isExpired: true, 

        // پیام‌هایی که در صفحه انقضا نمایش داده می‌شود
        popupTitle: "🔒 اشتراک شما به پایان رسیده است",
        popupMessage: "برای استفاده مجدد از منوی دیجیتال، لطفاً اشتراک خود را تمدید کنید.",
        
        // تنظیمات دکمه تمدید
        buttonText: "تمدید اشتراک",
        buttonLink: "https://your-renewal-link.com" // لینک صفحه پرداخت یا تماس با شما
    }
};
